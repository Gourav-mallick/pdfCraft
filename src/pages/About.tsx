...
export default function About() {
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <div className="inline-flex p-4 bg-blue-100 rounded-2xl mb-6">
      <img
        src="/image.png"
        alt="Gourav Chandra Mallick"
        className="w-20 h-20 rounded-2xl object-cover"
      />
    </div>

    <h2 className="text-gray-900 mb-4">
      Designed & Built by Gourav Chandra Mallick
    </h2>

    <p className="text-gray-700 mb-6">
      PDFCraft is independently designed and developed by Gourav Chandra Mallick. 
      As the UI/UX designer, developer, and founder, every detail — from user 
      experience to performance — is crafted with care, simplicity, and purpose.
    </p>

    <p className="text-gray-700">
      I’m constantly improving PDFCraft based on real user needs and feedback. 
      If you have questions, ideas, or suggestions, feel free to reach out through 
      the contact page — I personally read every message.
    </p>
  </div>
</section>
